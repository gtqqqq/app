...
(function () {
    ...
    var la = function (a, b) {
        ...
        return a
    }, oa = /&/g, pa = /</g, qa = />/g, ra = /"/g, sa = /'/g, ta = /\x00/g, na = /[\x00&<>"']/, wa = function (a, b) {
        var c = 0;
        a = ma(String(a)).split(".");
        b = ma(String(b)).split(".");
    ...
    var Ga = Array.prototype.indexOf ? function (a, b, c) {
        ...
        return 0 > b ? null : p(a) ? a.charAt(b) :
            a[b]
    }, Oa = function (a, b) {
        return 0 <= Ga(a, b)
    }, Pa = function (a, b) {
    ...
    var gb = D("Opera"), E = D("Trident") || D("MSIE"), F = D("Edge"),
        hb = D("Gecko") && !(-1 != B.toLowerCase().indexOf("webkit") && !D("Edge")) && !(D("Trident") || D("MSIE")) && !D("Edge"),
        G = -1 != B.toLowerCase().indexOf("webkit") && !D("Edge"), H = D("Macintosh"), ib = D("Windows"),
        jb = D("Android"), kb = cb(), lb = D("iPad"), mb = D("iPod"), nb = function () {
            var a = m.document;
    ...
    var vb = D("Firefox"), wb = cb() || D("iPod"), xb = D("iPad"),
        yb = D("Android") && !(bb() || D("Firefox") || D("Opera") || D("Silk")), zb = bb(),
        Ab = D("Safari") && !(bb() || D("Coast") || D("Opera") || D("Edge") || D("Silk") || D("Android")) && !(cb() || D("iPad") || D("iPod"));
    var Bb = function () {
    }, Cb = "function" == typeof Uint8Array, Fb = function (a, b, c) {
        a.b = null;
        b || (b = []);
        a.m = void 0;
        a.c = -1;
        ...
        a.j = {};
        if (c) for (b = 0; b < c.length; b++) d = c[b], d < a.i ? (d += a.c, a.a[d] = a.a[d] || Db) : (Eb(a), a.h[d] = a.h[d] || Db)
    }, Db = Object.freeze ? Object.freeze([]) : [], Eb = function (a) {
        var b = a.i + a.c;
        a.a[b] || (a.h = a.a[b] = {})
    }, J = function (a, b, c) {
        b < a.i ? a.a[b + a.c] =
        ...
        if (a.b) for (var b in a.b) {
            var c = a.b[b];
            if (t(c)) for (var d = 0; d < c.length; d++) c[d] && c[d].qa(); else c && c.qa()
        }
    };
    ...
    var Hb = function (a) {
        ...
        return a
    }, Jb = null, Kb = function (a) {
        if (null !== Jb) var b = Jb; else {
    ...
    var Mb = !E || 9 <= Number(tb), Nb = !E || 9 <= Number(tb), Ob = E && !I("9");
    !G || I("528");
    ...
    y(K, Tb);
    var Vb = Lb([1, 4, 2]), Ub = Lb({2: "touch", 3: "pen", 4: "mouse"}), Wb = function (a) {
    ...
    var Xb = "closure_listenable_" + (1E6 * Math.random() | 0), Yb = function (a) {
        return !(!a || !a[Xb])
    }, Zb = 0;
    ...
    bc.prototype.add = function (a, b, c, d, e) {
        ...
        a || (a = this.a[f] = [], this.b++);
        var g = cc(a, b, d, e);
        -1 < g ? (b = a[g], c || (b.Da = !1)) : (b = new $b(b, this.src, f, !!d, e), b.Da = c, a.push(b));
        return b
    };
    ...
    var fc = "closure_lm_" + (1E6 * Math.random() | 0), gc = {}, hc = 0, jc = function (a, b, c, d, e) {
        ...
        if (a.addEventListener) Pb || (e = g), void 0 === e && (e = !1),
            a.addEventListener(b.toString(), d, e); else if (a.attachEvent) a.attachEvent(oc(b.toString()), d); else throw Error("addEventListener and attachEvent are unavailable.");
        hc++;
        return c
    }, nc = function () {
        var a = pc, b = Nb ? function (c) {
        ...
        return Yb(a) ? a.h.add(String(b), c, !0, v(d) ? !!d.capture : !!d, e) : lc(a, b, c, !0, d, e)
                      ...
                      b, c, d, e) {
        if (t(b)) for (var f = 0; f < b.length; f++) qc(a, b[f], c, d, e); else d = v(d) ? !!d.capture : !!d, c = kc(c), Yb(a) ? a.W(b, c, d, e) : a && (a = mc(a)) && (b = ec(a, b, c, d, e)) && rc(b)
    }, rc = function (a) {
        if (!ba(a) && a && !a.removed) {
            var b = a.src;
            if (Yb(b)) dc(b.h, a); else {
        ...
        var e = !0;
        if (a =
                mc(a)) if (b = a.a[b.toString()]) for (b = b.concat(), a = 0; a < b.length; a++) {
            var f = b[a];
        ...
        if (!Nb) {
            ...
            if (!(0 > d.keyCode || void 0 != d.returnValue)) {
                ...
                for (e = 0; !b.c && e < d.length; e++) b.a = d[e], f = tc(d[e], a, !1, b), c = c && f
            }
            return c
        }
    ...
    }, uc = "__closure_events_fn_" + (1E9 * Math.random() >>> 0), kc = function (a) {
    ...
    var Bc = !E || 9 <= Number(tb), Cc = !hb && !E || E && 9 <= Number(tb) || hb && I("1.9.1"), Dc = E && !I("9");
    var Fc = function () {
        this.a = "";
        this.b = Ec
    };
    ...
    var Oc = function (a) {
        ...
        }, Xc = {SCRIPT: 1, STYLE: 1, HEAD: 1, IFRAME: 1, OBJECT: 1}, Yc = {IMG: " ", BR: "\n"}, Zc = function (a) {
            if (E && !I("9")) {
        ...
        ad = function (a, b, c) {
            if (!(a.nodeName in Xc)) if (3 == a.nodeType) c ? b.push(String(a.nodeValue).replace(/(\r\n|\r|\n)/g, "")) : b.push(a.nodeValue); else if (a.nodeName in Yc) b.push(Yc[a.nodeName]); else for (a = a.firstChild; a;) ad(a, b, c), a = a.nextSibling
        }, Sc = function (a) {
    ...
    h.contains = Vc;
    var cd = "StopIteration" in m ? m.StopIteration : {message: "StopIteration", stack: ""}, dd = function () {
    };
    ...
    M.prototype.i = function (a) {
        ed(this);
        var b = 0, c = this.h, d = this, e = new dd;
        e.next = function () {
    ...
    var gd = function (a) {
        ...
        if (a.forEach && "function" == typeof a.forEach) a.forEach(b, c); else if (da(a) || p(a)) Ha(a, b, c); else {
            if (a.V && "function" == typeof a.V) var d = a.V(); else if (a.M && "function" == typeof a.M) d = void 0; else if (da(a) || p(a)) {
                d = [];
    ...
    h.V = function () {
        ld(this);
        for (var a = this.a.M(), b = this.a.V(), c = [], d = 0; d < b.length; d++) for (var e = a[d], f = 0; f < e.length; f++) c.push(b[d]);
        return c
    };
    h.M = function (a) {
        ld(this);
        var b = [];
        if (p(a)) nd(this, a) && (b = Qa(b, this.a.get(md(this, a)))); else {
            a = this.a.M();
    ...
    var od = {Dd: !0}, pd = {Cd: !0}, qd = {Ed: !0}, rd = function () {
    ...
    var yd = function (a, b) {
        ...
        return "zSoyz"
    }, Ad = /^<(body|caption|col|colgroup|head|html|tr|td|th|tbody|thead|tfoot)>/i, xd = {};
    var Bd = function (a, b) {
    ...
    var Fd = function (a, b, c, d, e, f) {
        ...
        if (hb) a = Gd(a); else if (H && G) switch (a) {
            case 93:
                a = 91
        }
        return a
    ...
    var O = function (a, b) {
        ...
        e = !0;
        if (d) for (var f = d.length - 1; !b.c && 0 <= f; f--) {
            var g = b.a = d[f];
            e = Id(g, c, !0, b) && e
        }
        b.c || (g = b.a = a, e = Id(g, c, !0, b) && e, b.c || (e = Id(g, c, !1, b) && e));
        if (d) for (f = 0; !b.c && f < d.length; f++) g = b.a = d[f], e = Id(g, c, !1, b) && e;
        return e
    };
    ...
    var Kd = {
        ...
        PageDown: 34,
        Insert: 45
    }, Md = E || F || G && I("525"), Nd = H && hb;
    h = Jd.prototype;
    h.zb = function (a) {
        if (G || F) if (17 == this.J && !a.ctrlKey || 18 == this.J && !a.altKey || H && 91 == this.J && !a.metaKey) this.aa = this.J = -1;
    ...
    h.handleEvent = function (a) {
        var b = a.b, c = b.altKey;
        if (E && "keypress" == a.type) var d = this.aa; else if ((G || F) && "keypress" == a.type) d = this.aa; else if (gb && !G) d = this.aa; else {
            d = b.keyCode || this.aa;
            var e = b.charCode || 0;
            Nd && (c = this.Oa);
            H && 63 == e && 224 == d && (d = 191)
    ...
    h.W = function (a, b, c, d, e) {
        if (t(b)) for (var f = 0; f < b.length; f++) this.W(a, b[f], c, d, e); else c = c || this.handleEvent, d = v(d) ? !!d.capture : !!d, e = e || this.b || this, c = kc(c), d = !!d, b = Yb(a) ? ec(a.h, String(b), c, d, e) : a ? (a = mc(a)) ? ec(a, b, c, d, e) : null : null, b && (rc(b), delete this.a[b.key]);
        return this
    };
    ...
    Q.prototype.R = function (a, b) {
        ...
        var c = 0, d = this.A(), e = this.A(), f = !1, g = !1, k = !1, l = Ra(vc(b));
        Ha(l, function (a) {
    ...
    h.Sa = function (a, b) {
        ...
        } else if (E || gb) if (c = c ? "on" : "", a.setAttribute("unselectable", c), b) for (a = 0; d = b[a]; a++) d.setAttribute("unselectable", c)
    };
    h.gb = function (a, b) {
        he(a, this.A() + "-rtl", b)
    };
    ...
    h.na = function (a) {
        var b = ne.l.na.call(this, a), c = a.L;
    ...
    var ie = function (a, b) {
        ...
        a = a.$();
        if (!a) return "";
        if (!p(a)) if (t(a)) a = Ja(a, bd).join(""); else {
    ...
    te.prototype.h = function (a) {
        if (this.a) this.a = !1; else {
            var b = a.b, c = b.button, d = b.type, e = Ce(b, "mousedown");
    ...
    var Fe = function (a) {
        ...
        if (a instanceof Jc) {
            var b = Ge;
            if (a instanceof Jc && a.constructor === Jc && a.h === Ic) var c = a.a; else za("expected object of type SafeHtml, got '" + a + "' of type " + ca(a)), c = "type_error:SafeHtml";
            a = b(c, a.c())
    ...
    var Pe = function (a) {
        a = a || {};
        var b = a.content, c = Ge, d = '<div role="button"' + (a.id ? ' id="' + Me(a.id) + '"' : "") + ' class="';
        var e = a || {};
        var f = "goog-inline-block jfk-button ", g = e.style;
    ...
    var qf = function (a, b, c, d) {
        ...
        if (b.a) b.a.c = null, vf(b, c, d); else try {
    ...
    h.na = function (a) {
        ...
        var b = a.j;
        var c = {disabled: !a.a(), checked: a.oa(), style: a.Y, title: a.L, Gb: a.Ca, value: a.Z, width: a.fa};
    ...
    Hf.prototype.tb = function () {
        chrome.runtime.sendMessage({audioSrc: If(this.Ba, this.sa)})
    };
...
*/
    ...
    Nf.prototype.cancel = function (a) {
        if (this.a) this.c instanceof Nf && this.c.cancel(); else {
            if (this.b) {
                var b = this.b;
                delete this.b;
    ...
    var Wf = function (a) {
        ...
        a.c = b;
        d && (k = w(a.K, a, !0), d = w(a.K, a, !1), b instanceof
        Nf ? (Vf(b, k, d), b.D = !0) : b.then(k, d));
    ...
    var cg = function (a, b) {
        ...
        var d = Gc(a), e = document.createElement("SCRIPT"), f = {pb: e, ha: void 0}, g = new Nf(Zf, f), k = null,
    ...
    dg.prototype.send = function (a, b, c, d) {
        ...
        b = {timeout: this.ha, wb: !0};
        e = Gc(this.b);
        var f = /\?/.test(e) ? "&" : "?";
        for (l in a) for (var g = t(a[l]) ? a[l] : [a[l]], k = 0; k < g.length; k++) null != g[k] && (e += f + encodeURIComponent(l) + "=" + encodeURIComponent(String(g[k])), f = "&");
        var l = Hc(e);
        l = cg(l, b);
    ...
    jg.prototype.D = function (a) {
        ...
        if (this.m) {
            ...
            (864E5 < Math.abs(b - c) || d != a) && (new dg("https://translate.googleapis.com/translate_a/l",
                "cb")).send({client: "gtx", hl: d}, w(this.u, this, d))
        }
    };
    var mg = function (a, b) {
        var c = [], d;
        ...
        if (a.query) if (a.qb) {
            ...
            if (a.ab) {
                ...
                for (e = 0; e < d; e++) {
                    ...
                    } else for (f = f.terms, g = f.length, k = 0; k < g; k++) {
                        var l = f[k];
                        b += 3 > k ? (0 != k ? ", " : "") + He(l) : ""
                    }
                    b += "</td></tr>"
    ...
    var wg = new vg("SEVERE", 1E3), xg = new vg("CONFIG", 700), yg = new vg("FINE", 500);
    ...
    ug.prototype.log = function (a, b, c) {
        if (a.value >= zg(this).value) for (u(b) && (b = b()), a = new sg(a, String(b), this.h), c && (a.a = c), c = this; c;) c = c.a
    };
    var Ag = {}, Bg = null, Cg = function (a) {
    ...
    y(Kg, N);
    var Lg = Kg.prototype, Mg = Cg("goog.net.XhrIo");
    Lg.N = Mg;
    var Ng = /^https?$/i, Og = ["POST", "PUT"], Pg = [], Qg = function (a, b, c, d) {
        var e = new Kg;
        Pg.push(e);
    ...
    var Xg = function (a) {
        if (a.b && "undefined" != typeof aa) if (a.T[1] && 4 == Yg(a) && 2 == Zg(a)) Dg(a.N, Rg(a, "Local request error detected and ignored")); else if (a.u && 4 == Yg(a)) xf(a.ra, 0, a); else if (O(a, "readystatechange"), 4 == Yg(a)) {
            Dg(a.N, Rg(a, "Request complete"));
            a.b = !1;
            try {
                if ($g(a)) O(a, "complete"), O(a, "success"); else {
                    a.i = 6;
                    try {
    ...
    var Y = function (a) {
        var b = a.a();
        a = a.data;
        for (var c = {}, d = 0; d < a.length; d++) if (void 0 !== a[d] && null !== a[d]) {
            var e = !1, f;
            for (f in b) {
                var g = b[f];
                var k = f;
            ...
            if (e) if (g.v) if (g.g) for (c[k] = [], e = 0; e < a[d].length; e++) c[k].push(g.v(a[d][e])); else c[k] = g.v(a[d]); else c[k] = a[d]
        }
        return c
    };
    ...
    var Z = function (a, b) {
        ...
        for (e in b) {
            var f = A(d[e]), g = b[e];
            if (f.w) if (g instanceof Array) {
                var k = [];
                for (var l = 0; l < g.length; l++) k.push(f.w(g[l]).qa())
            } else k = f.w(g).qa(); else k = g;
            c[f.f] = k
        }
        return a
    };
    ...
    var Fh = {
        word: {f: 0, g: !1},
        styles: {f: 1, g: !0},
        has_preceeding_space: {f: 2, g: !1},
        attach_to_next_token: {f: 3, g: !1},
        confidence: {f: 4, g: !1},
        start_pos: {f: 5, g: !1},
        end_pos: {f: 6, g: !1},
        not_from_first_segment: {f: 7, g: !1}
    };
    ph.prototype.a = function () {
        return Fh
    };
    var Gh = {
        src_phrase: {f: 0, g: !1}, alternative: {
            f: 2, w: function (a) {
                return Z(rh, a)
            }, v: function (a) {
                return Y(new rh(a))
        ...
        }, raw_src_segment: {f: 4, g: !1}, start_pos: {f: 5, g: !1}, end_pos: {f: 6, g: !1}
    };
    qh.prototype.a = function () {
        return Gh
    };
    var Hh = {
        word_postproc: {f: 0, g: !1},
        score: {f: 1, g: !1},
        has_preceeding_space: {f: 2, g: !1},
        attach_to_next_token: {f: 3, g: !1}
    };
    ...
    var Ih = {begin: {f: 0, g: !1}, end: {f: 1, g: !1}};
    ...
    var Kh = {
        word: {f: 0, g: !1},
        reverse_translation: {f: 1, g: !0},
        synset_id: {f: 2, g: !0},
        score: {f: 3, g: !1},
        previous_word: {f: 4, g: !1}
    };
    uh.prototype.a = function () {
        return Kh
    };
    var Lh = {
        pos: {f: 0, g: !1}, terms: {f: 1, g: !0}, entry: {
            f: 2, w: function (a) {
                return Z(uh, a)
            }, v: function (a) {
                return Y(new uh(a))
            }, g: !0
        }, base_form: {f: 3, g: !1}, pos_enum: {f: 4, g: !1}
    };
    vh.prototype.a = function () {
        return Lh
    };
    var Mh = {gloss: {f: 0, g: !1}, definition_id: {f: 1, g: !1}, example: {f: 2, g: !1}};
    ...
    var Oh = {synonym: {f: 0, g: !0}, definition_id: {f: 1, g: !1}};
    ...
    var Rh = {
        spell_html_res: {f: 0, g: !1},
        spell_res: {f: 1, g: !1},
        correction_type: {f: 2, g: !0},
        correction_translation: {f: 3, g: !1},
        related: {f: 4, g: !1},
        confident: {f: 5, g: !1}
    };
    ...
    var Sh = {
        srclangs: {f: 0, g: !0},
        extended_srclangs: {f: 3, g: !0},
        detected_target: {f: 1, g: !1},
        srclangs_confidences: {f: 2, g: !0}
    };
    Ch.prototype.a = function () {
        return Sh
    };
    var Th = {title: {f: 0, g: !1}, description: {f: 1, g: !1}, image_url: {f: 2, g: !1}, image_ref_url: {f: 3, g: !1}};
    ...
    var Uh = {
        ...
        }, src: {f: 2, g: !1}, err: {f: 3, g: !1}, styled_words: {
            f: 4, w: function (a) {
                return Z(ph, a)
            }, v: function (a) {
                return Y(new ph(a))
    ...
    Vh.prototype.h = function (a, b, c) {
        ...
        if (!$g(c) || "[" != ah(c)[0] && "{" != ah(c)[0]) {
            ...
            b = ah(c);
            c = {"class": "trans.common.TranslationAPI", func: "handleSingleResult_", url: String(c.j)};
            try {
                d = JSON.parse(b)
            } catch (f) {
                throw a =
    ...
    var ai = function (a, b, c, d) {
        if ("" != a) {
            ...
            var f = lg();
            c = new kd("source=" + c);
            var g = window.selection, k = a.a + "/translate_a/single", l = new kd, C = new kd;
            l.set("client", a.c);
            l.set("sl", d);
            l.set("tl", f);
            l.set("hl", e);
    ...
    $h.prototype.a = function (a, b, c, d) {
        if (null != d) {
            ...
            yd(c, {query: b, qb: k, Fb: l, Cb: e, Db: Re, ab: d.dict, popup: a});
    ...
    var gi = $h.H(), hi = chrome.extension.getBackgroundPage();
    ...
    var ii = function () {
        var a = L("search-bar"), b = Gf(), c = L("text-input");
        ae(b, a);
        jc(b, "action", mi);
