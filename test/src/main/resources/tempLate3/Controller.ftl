...
<#if method == "insert-Map">	
    ...
    public ResultDto<Integer> insert${tableName}(HttpServletRequest httpServletRequest,
			${tableName}Form ${tableVar}Form) throws BusinessException {
...
<#if method == "update-Map">	
    ...
    public ResultDto<Integer> update${tableName}(HttpServletRequest httpServletRequest,
			${tableName}Form ${tableVar}Form) throws BusinessException {
