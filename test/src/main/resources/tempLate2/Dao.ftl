...
<#list methods as method>
	...
	public List
    <String> find${tableName}byIdList(@Param("idList")List
    <String> idList);
    </#if>
    <#if method == "List_Map-Map">
	public List
        <Map
        <String, Object>> find${tableName}${serverName}List(@Param("paramMap")Map
        <String, Object> paramMap);
    </#if>
    <#if method == "insert-Map">
	public Integer insert${tableName}(@Param("paramMap")Map
        <String, Object> paramMap);
    </#if>

    <#if method == "update-Map">
	public Integer update${tableName}(@Param("paramMap")Map
        <String, Object> paramMap);
    </#if>
    <#if method == "Map-Map">
	public Map
        <String, Object> find${tableName}(@Param("paramMap")Map
        <String, Object> paramMap);
    </#if>
    <#if method == "HashMap-Page-PaginationRequest">
	public List
        <HashMap
        <String, Object>> find${tableName}ListByPage(@Param("paginationRequest")PaginationRequest paginationRequest);
