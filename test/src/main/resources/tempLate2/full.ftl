...
public List
<HashMap
<String, Object>> find${tableName}ByConditions(@Param("paginationRequest")PaginationRequest paginationRequest);

public Map
<String, Object> find${tableName}bySum(@Param("paginationRequest")PaginationRequest paginationRequest);
...
//modelDao
	...
	List
<HashMap
<String, Object>> datalist = ${tableVar}Dao.find${tableName}ByConditions(paginationRequest);
    ...
    <PaginationMapResponse> find${tableName}ListByPage(PaginationRequest paginationRequest) {
        ...
        <PaginationMapResponse> serviceResultDto = new PageResultDto
            <PaginationMapResponse>();
                ...
                Map
                <String
                , Object> resultMap = ${tableName}Model.find${tableName}bySum(paginationRequest);
                serviceResultDto.setSuccess(true);
                ...
                Map
                <String
                , Object> dataMap = ${tableVar}Api.find${tableName}bySum(paginationRequest).getResult();
                return dataMap;
                }
                /////////////////////////Controller
                @Resource
                ...
                @ResponseBody
                @RequestMapping(value = "/find${tableName}ListByPage.ajax", method = { RequestMethod.GET,
                RequestMethod.POST })
            ...
            ${tableName}Form.setOrderColumnType(orderDir);
                ...
                <Map
                <String
                , Object>> findSum${tableName}Info(HttpServletRequest httpServletRequest,
            ${tableName}Form ${tableVar}Form) throws BusinessException {
                PaginationRequest paginationRequest = PaginationUtils.createPaginationRequest(${tableVar}Form);
