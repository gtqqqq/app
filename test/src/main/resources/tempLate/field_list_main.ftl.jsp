...
<div class="contentpanel">
    <div class="panel panel-default">
            ...
            <div class="form-horizontal">
                <form id="searchForm" class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-8">
                                    <div class="input-group">
                                        <input type="text" class="form-control date-picker" name="queryDate"
                                               id="queryDate" value="${lastDay!''}" placeholder="请选择查询日期" required>
                    ...
                    <div class="col-sm-4 col-md-4  m-b-15 text-right pull-right">
                        <div class="form-group">
                            <div class="col-xs-12">
                                <a id="searchBtn" href="Javascript:void(0);" class="btn btn-info"><i
        ...
        <table class="table dataTable no-footer table-bordered table-hover" id="dataListTable" role="grid"
